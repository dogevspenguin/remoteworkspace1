...
public class MCreatorTitaniumHoe extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:titaniumhoe")
	public static final Item block = null;

	public MCreatorTitaniumHoe(Elementsplc instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("titaniumhoe").setRegistryName("titaniumhoe").setCreativeTab(MCreatorAntarcticraft.tab));
	}
