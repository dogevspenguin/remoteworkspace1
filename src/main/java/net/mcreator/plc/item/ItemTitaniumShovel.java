...
public class ItemTitaniumShovel extends ElementsPolarcraft.ModElement {
	@GameRegistry.ObjectHolder("plc:titaniumshovel")
	public static final Item block = null;
	public ItemTitaniumShovel(ElementsPolarcraft instance) {
		super(instance, 6);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("titaniumshovel").setRegistryName("titaniumshovel").setCreativeTab(TabAntarcticraft.tab));
	}
