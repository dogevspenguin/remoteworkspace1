...
public class ItemTitaniumPickaxe extends ElementsPolarcraft.ModElement {
	...
	public void initElements() {
		...
		}.setUnlocalizedName("titaniumpickaxe").setRegistryName("titaniumpickaxe").setCreativeTab(TabAntarcticraft.tab));
	}
