...
import net.mcreator.plc.procedure.ProcedureFusionitemRightClickedOnBlock;
import net.mcreator.plc.creativetab.TabAntarcticraft;
import net.mcreator.plc.ElementsPolarcraft;

@ElementsPolarcraft.ModElement.Tag
public class ItemFusionblock extends ElementsPolarcraft.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("plc:fusionblock", "inventory"));
	}
	public static class ItemCustom extends Item {
		public ItemCustom() {
			setMaxDamage(0);
			maxStackSize = 64;
			setUnlocalizedName("fusionblock");
			setRegistryName("fusionblock");
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureFusionitemRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
