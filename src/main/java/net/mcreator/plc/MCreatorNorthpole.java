...
public class MCreatorNorthpole extends Elementsplc.ModElement {
	public static int DIMID = 4;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("plc:northpole")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("plc:northpole_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;

	public MCreatorNorthpole(Elementsplc instance) {
		super(instance, 17);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setUnlocalizedName("northpole").setRegistryName("northpole"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension northpole is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("northpole", "_northpole", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("plc:northpole", "inventory"));
	}
				...
				for (int j7 = -1; j7 <= 1; ++j7) {
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							boolean flag = k8 < 0;
							this.world.setBlockState(new BlockPos(k9, k10, k11), flag ? MCreatorCompacice.block.getDefaultState().getBlock()
			...
			for (int i8 = 0; i8 < 4; ++i8) {
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						...
						this.world.setBlockState(new BlockPos(l10, l11, k12), flag1 ? MCreatorCompacice.block.getDefaultState().getBlock()
				...
				for (int j1 = -2; j1 <= 2; ++j1) {
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							int k2 = k + k1 * 0 - j1 * 1;
							boolean flag = l1 < 0;
							this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? MCreatorCompacice.block.getDefaultState().getBlock()
									.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("northpole_portal");
			setRegistryName("northpole_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != MCreatorCompacice.block.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == MCreatorCompacice.block.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != MCreatorCompacice.block.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != MCreatorCompacice.block
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = Blocks.ICE.getDefaultState();
		private static final IBlockState STONE2 = MCreatorCompacice.block.getDefaultState();
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("plc:snowvallaynorth")),
