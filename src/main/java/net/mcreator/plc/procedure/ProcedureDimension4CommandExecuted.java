...
public class ProcedureDimension4CommandExecuted extends ElementsPolarcraft.ModElement {
	public ProcedureDimension4CommandExecuted(ElementsPolarcraft instance) {
		super(instance, 176);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dimension4CommandExecuted!");
			return;
		}
