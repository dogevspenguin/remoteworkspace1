...
public class ProcedureDimension3CommandExecuted extends ElementsPolarcraft.ModElement {
	public ProcedureDimension3CommandExecuted(ElementsPolarcraft instance) {
		super(instance, 177);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dimension3CommandExecuted!");
			return;
		}
