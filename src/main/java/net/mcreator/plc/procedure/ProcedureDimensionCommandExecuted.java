...
public class ProcedureDimensionCommandExecuted extends ElementsPolarcraft.ModElement {
	public ProcedureDimensionCommandExecuted(ElementsPolarcraft instance) {
		super(instance, 173);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure DimensionCommandExecuted!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (!entity.world.isRemote && !entity.isRiding() && !entity.isBeingRidden() && entity instanceof EntityPlayerMP) {
			int dimensionID = WorldSouthpole.DIMID;
