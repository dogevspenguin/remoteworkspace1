...
public class ProcedureDimension2CommandExecuted extends ElementsPolarcraft.ModElement {
	public ProcedureDimension2CommandExecuted(ElementsPolarcraft instance) {
		super(instance, 174);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure Dimension2CommandExecuted!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (!entity.world.isRemote && !entity.isRiding() && !entity.isBeingRidden() && entity instanceof EntityPlayerMP) {
			int dimensionID = WorldNorthpole.DIMID;
