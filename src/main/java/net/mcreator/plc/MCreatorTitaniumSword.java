...
public class MCreatorTitaniumSword extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:titaniumsword")
	public static final Item block = null;

	public MCreatorTitaniumSword(Elementsplc instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("titaniumsword").setRegistryName("titaniumsword").setCreativeTab(MCreatorAntarcticraft.tab));
	}
