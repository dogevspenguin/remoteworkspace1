...
public class WorldSouthpole extends ElementsPolarcraft.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new ItemSouthpole().setUnlocalizedName("southpole").setRegistryName("southpole"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(ItemSouthpole.block, 0, new ModelResourceLocation("plc:southpole", "inventory"));
	}
