...
public class StructurePenguintrap extends ElementsPolarcraft.ModElement {
	public StructurePenguintrap(ElementsPolarcraft instance) {
		super(instance, 169);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 10000) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("plc", "penguin_trap"));
				if (template == null)
					return;
