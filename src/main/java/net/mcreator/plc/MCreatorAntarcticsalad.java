...
public class MCreatorAntarcticsalad extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:antarcticsalad")
	public static final Item block = null;

	public MCreatorAntarcticsalad(Elementsplc instance) {
		super(instance, 30);
	}
	...
	public static class ItemFoodCustom extends ItemFood {
		...
		protected void onFoodEaten(ItemStack itemStack, World world, EntityPlayer entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorAntarcticsaladFoodEaten.executeProcedure($_dependencies);
			}
		}
	}
}
