...
public class MCreatorTrihydrideHoe extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:trihydridehoe")
	public static final Item block = null;

	public MCreatorTrihydrideHoe(Elementsplc instance) {
		super(instance, 27);
	}

	@Override
	public void initElements() {
		elements.items.add(() -> new ItemHoe(EnumHelper.addToolMaterial("TRIHYDRIDEHOE", 6, 1164, 12f, 2f, 42)) {
		...
		}.setUnlocalizedName("trihydridehoe").setRegistryName("trihydridehoe").setCreativeTab(MCreatorAntarcticraft.tab));
	}
