...
public class GuiFusionreatorgui extends ElementsPolarcraft.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 53, 21) {
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 116, 39) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("plc:textures/fusionreatorgui.png");
		@Override
