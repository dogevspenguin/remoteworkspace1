...
public class MCreatorIcevallaynorth extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:icevallaynorth")
	public static final BiomeGenCustom biome = null;

	public MCreatorIcevallaynorth(Elementsplc instance) {
		super(instance, 68);
	}
	...
	static class BiomeGenCustom extends Biome {
		public BiomeGenCustom() {
			...
			fillerBlock = MCreatorCompacice.block.getDefaultState();
