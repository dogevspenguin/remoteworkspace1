...
public class BlockLeadOre extends ElementsPolarcraft.ModElement {
	@GameRegistry.ObjectHolder("plc:leadore")
	public static final Block block = null;
	public BlockLeadOre(ElementsPolarcraft instance) {
		super(instance, 143);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("plc:leadore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemLeadDust.block, (int) (3)));
		}
	}
}
