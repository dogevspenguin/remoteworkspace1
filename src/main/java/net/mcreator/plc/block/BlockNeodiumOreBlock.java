...
public class BlockNeodiumOreBlock extends ElementsPolarcraft.ModElement {
	@GameRegistry.ObjectHolder("plc:neodiumoreblock")
	public static final Block block = null;
	public BlockNeodiumOreBlock(ElementsPolarcraft instance) {
		super(instance, 48);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("neodiumoreblock"));
