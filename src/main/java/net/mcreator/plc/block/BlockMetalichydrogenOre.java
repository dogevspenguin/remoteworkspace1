...
public class BlockMetalichydrogenOre extends ElementsPolarcraft.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("metalichydrogenore"));
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemMetalichydrogenDust.block, (int) (3)));
		}
	}
}
