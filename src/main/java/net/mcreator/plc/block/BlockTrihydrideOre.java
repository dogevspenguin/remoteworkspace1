...
public class BlockTrihydrideOre extends ElementsPolarcraft.ModElement {
	...
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("trihydrideore"));
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemTrihydrideIngot.block, (int) (1)));
		}
	}
}
