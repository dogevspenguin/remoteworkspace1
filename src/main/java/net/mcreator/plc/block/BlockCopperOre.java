...
public class BlockCopperOre extends ElementsPolarcraft.ModElement {
	@GameRegistry.ObjectHolder("plc:copperore")
	public static final Block block = null;
	public BlockCopperOre(ElementsPolarcraft instance) {
		super(instance, 153);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("plc:copperore", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCopperGem.block, (int) (1)));
		}
	}
}
