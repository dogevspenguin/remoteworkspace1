...
import net.mcreator.plc.item.ItemCabbageleave;
...
public class BlockCabbage extends ElementsPolarcraft.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("plc:cabbage", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCabbageleave.block, (int) (4)));
		}
