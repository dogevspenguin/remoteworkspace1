...
public class BlockGreaterburnet extends ElementsPolarcraft.ModElement {
	@GameRegistry.ObjectHolder("plc:greaterburnet")
	public static final Block block = null;
	public BlockGreaterburnet(ElementsPolarcraft instance) {
		super(instance, 191);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("plc:greaterburnet", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("greaterburnet");
			setRegistryName("greaterburnet");
		}
