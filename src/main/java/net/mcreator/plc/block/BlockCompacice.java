...
public class BlockCompacice extends ElementsPolarcraft.ModElement {
	@GameRegistry.ObjectHolder("plc:compacice")
	public static final Block block = null;
	public BlockCompacice(ElementsPolarcraft instance) {
		super(instance, 1);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("compacice"));
