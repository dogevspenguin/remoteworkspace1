...
public class MCreatorPenguingun extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:penguingun")
	public static final Item block = null;
	public static final int ENTITYID = 6;

	public MCreatorPenguingun(Elementsplc instance) {
		super(instance, 37);
	}
			...
			if (!world.isRemote && entityLivingBase instanceof EntityPlayerMP) {
				...
				world.playSound((EntityPlayer) null, (double) x, (double) y, (double) z,
						(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY
								.getObject(new ResourceLocation(("entity.arrow.shoot"))), SoundCategory.NEUTRAL, 1, 1f
								/ (itemRand.nextFloat() * 0.5f + 1f) + (power / 2));
	...
	public static class EntityArrowCustom extends EntityTippedArrow {
		...
		public void onCollideWithPlayer(EntityPlayer entity) {
			...
			World world = this.world;
			{
				...
				MCreatorPenguingunBullet.executeProcedure($_dependencies);
			}
		}
