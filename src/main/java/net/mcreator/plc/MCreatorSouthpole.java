...
public class MCreatorSouthpole extends Elementsplc.ModElement {
	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("plc:southpole")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("plc:southpole_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;

	public MCreatorSouthpole(Elementsplc instance) {
		super(instance, 14);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ModTrigger().setUnlocalizedName("southpole").setRegistryName("southpole"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension southpole is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("southpole", "_southpole", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("plc:southpole", "inventory"));
	}
					...
					for (int l7 = 1; l7 < 3; ++l7) {
						for (int k8 = -1; k8 < 3; ++k8) {
							...
							this.world.setBlockState(new BlockPos(k9, k10, k11), flag
									? Blocks.ICE.getDefaultState().getBlock().getDefaultState()
	...
	public static class BlockCustomPortal extends BlockPortal {
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("southpole_portal");
			setRegistryName("southpole_portal");
			setLightLevel(0.1F);
		}
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		private static final IBlockState STONE = MCreatorCompacice.block.getDefaultState();
		private static final IBlockState STONE2 = MCreatorSnowice.block.getDefaultState();
