...
import net.mcreator.plc.procedure.ProcedureFreezemobticlePlayerCollidesWithThisEntity;
import net.mcreator.plc.ElementsPolarcraft;

@ElementsPolarcraft.ModElement.Tag
public class EntityFreezemobticle extends ElementsPolarcraft.ModElement {
	public static final int ENTITYID = 24;
	public static final int ENTITYID_RANGED = 25;
	public EntityFreezemobticle(ElementsPolarcraft instance) {
		super(instance, 202);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("plc", "freezemobticle"), ENTITYID)
				.name("freezemobticle").tracker(64, 3, true).egg(-3342337, -3342337).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("plc:textures/frezze.png");
				}
			};
	...
	public static class EntityCustom extends EntityMob {
		...
		protected Item getDropItem() {
			return new ItemStack(Blocks.ICE, (int) (1)).getItem();
		}
		...
		public void onCollideWithPlayer(EntityPlayer entity) {
			...
			int z = (int) this.posZ;
			{
				...
				ProcedureFreezemobticlePlayerCollidesWithThisEntity.executeProcedure($_dependencies);
			}
		}
