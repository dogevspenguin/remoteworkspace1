...
public class EntityPenguin extends ElementsPolarcraft.ModElement {
	public static final int ENTITYID = 1;
	public static final int ENTITYID_RANGED = 2;
	public EntityPenguin(ElementsPolarcraft instance) {
		super(instance, 12);
	}
	...
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("plc", "penguin"), ENTITYID)
				.name("penguin").tracker(64, 3, true).egg(-16777216, -256).build());
	}
