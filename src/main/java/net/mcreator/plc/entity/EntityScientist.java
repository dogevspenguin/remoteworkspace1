...
public class EntityScientist extends ElementsPolarcraft.ModElement {
	public static final int ENTITYID = 10;
	public static final int ENTITYID_RANGED = 11;
	public EntityScientist(ElementsPolarcraft instance) {
		super(instance, 45);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("plc", "scientist"), ENTITYID)
				.name("scientist").tracker(64, 3, true).egg(-1, -6724096).build());
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderLiving customRender = new RenderLiving(renderManager, new ModelVillager(0.0F), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("plc:textures/sciencetise.png");
				}
			};
