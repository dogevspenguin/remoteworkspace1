...
public class MCreatorTrihydrideSword extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:trihydridesword")
	public static final Item block = null;

	public MCreatorTrihydrideSword(Elementsplc instance) {
		super(instance, 25);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("trihydridesword").setRegistryName("trihydridesword").setCreativeTab(MCreatorAntarcticraft.tab));
	}
