...
public class MCreatorTitaniumOre extends Elementsplc.ModElement {
	@GameRegistry.ObjectHolder("plc:titaniumore")
	public static final Block block = null;

	public MCreatorTitaniumOre(Elementsplc instance) {
		super(instance, 3);
	}
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(MCreatorTitaniumIngot.block, (int) (1)));
		}
	}
}
